...
conversation = [
{"role": "Bot doctor", "content": "I am your doctor How can I help you today. "},
...
def vitals_form():
    if request.method == "POST":
        ...
        bot_response,question_array,remedy,medicine= generate_question_with_langchain(patient_data,user_input,conversation)
        ...
        return jsonify({'result': bot_response,'Questions':question_array,'Remedy':remedy,'Medicine':medicine})
    else:
...
def generate_question_with_langchain(data,question,conversation):
    ...
    if patient_data is not None:
        try: 
            ...
            template = """ 
            Doctor: Act like you are a doctor that is an expert in medical health and is part of a hospital system called EZSHIFA.Do not provide consultancy/test/remedies/medicine at very first response
            ...
            remedy,medicine=remedy_medicine_check(ai_response)
        except AttributeError:
                            ai_response="How can we help you:"
        return ai_response,question_array,remedy,medicine
...
def remedy_medicine_check(ai_response):
    sentences = ai_response.split('\n')  
    remedy = []
    medicine = []
    ...
    for sentence in sentences:
        ...
        for i in sentence.strip.split(" "):
            ...
            if 'Remedies' in i or 'Remedy' in i or 'tips:'in i:
                remedy.append(sentence)
            elif 'Medicine' in i or 'Medicines' in i:
                medicine.append(sentence)

    return remedy, medicine
